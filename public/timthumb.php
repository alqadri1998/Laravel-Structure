...
if(! defined('FILE_CACHE_PREFIX') ) 		define ('FILE_CACHE_PREFIX', 'timthumb.php');				// What to put at the beg of all files in the cache directory so we can identify them
...
class php {
    ...
    protected function serveExternalImage(){
        ...
        $tempfile = tempnam($this->cacheDirectory, 'timthumb.php');
    ...
    protected function setMemoryLimit(){
        ...
        $inibytes = php::returnBytes($inimem);
        $ourbytes = php::returnBytes(MEMORY_LIMIT);
