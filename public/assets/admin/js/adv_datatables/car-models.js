var DatatableRemoteAjaxDemo = function () {
        var t = function () {
            var t = $(".manage-car-models").mDatatable({
                data: {
                    type: "remote",
                    source: {read: {url: window.Laravel.baseUrl+"list/car-models"}},
                    pageSize: 10,
            ...
            $("#manage-car-model-search").on("submit", function (a) {
                a.preventDefault();
                var searchParams = $('#manage-car-model-search').serializeObject();
