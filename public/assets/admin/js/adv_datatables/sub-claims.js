var claimReasonId = $('#claimReasonId').data('field-id');
var DatatableRemoteAjaxDemo = function () {
        var t = function () {
            var t = $(".manage-sub-claims").mDatatable({
                data: {
                    type: "remote",
                    source: {read: {url: window.Laravel.baseUrl+"list/claim-reasons/"+ claimReasonId +"/sub-claims"}},
                    pageSize: 10,
