...
var articleId = $('#articleId').data("field-id");
var DatatableRemoteAjaxDemo = function () {
    var t = function () {
        var t = $(".manage-comments").mDatatable({
            data: {
                type: "remote",
                source: {read: {url: window.Laravel.baseUrl+"admin/list/user/"+userId+"/article/"+articleId+"/comments"}},
                pageSize: 10,
            ...
            columns:
                [
                    ...
                    {field: "is_active", title: "Published",  width: 150},
