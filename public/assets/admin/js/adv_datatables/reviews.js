var DatatableRemoteAjaxDemo = function () {
        var t = function () {
            var t = $(".manage-reviews").mDatatable({
                data: {
                    type: "remote",
                    source: {read: {url: window.Laravel.baseUrl+"admin/list/reviews"}},
                    pageSize: 10,
                ...
                columns:
                    [
                        ...
                        {field: "store_title", title: "Store Title",  width: 150},
            ...
            $("#manage-reviews-search").on("submit", function (a) {
                a.preventDefault();
                var searchParams = $('#manage-reviews-search').serializeObject();
