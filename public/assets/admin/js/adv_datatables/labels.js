var DatatableRemoteAjaxDemo = function () {
        var t = function () {
            var t = $(".manage-labels").mDatatable({
                data: {
                    type: "remote",
                    source: {read: {url: window.Laravel.baseUrl+"list/labels"}},
                    pageSize: 10,
            ...
            $("#manage-label-search").on("submit", function (a) {
                a.preventDefault();
                var searchParams = $('#manage-label-search').serializeObject();
