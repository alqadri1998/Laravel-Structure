var DatatableRemoteAjaxDemo = function () {
    var t = function () {
        var t = $(".manage-offers").mDatatable({
            data: {
                type: "remote",
            ...
            columns:
                [
                    ...
                    {field: "long_description", title: "Description",  width: 150},
        ...
        $("#manage-offer-search").on("submit", function (a) {
            a.preventDefault();
            var searchParams = $('#manage-offer-search').serializeObject();
