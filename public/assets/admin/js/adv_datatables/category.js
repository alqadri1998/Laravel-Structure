var DatatableRemoteAjaxDemo = function () {
    var t = function () {
        var t = $(".manage-categories").mDatatable({
            data: {
                type: "remote",
                source: {read: {url: window.Laravel.baseUrl+"list/categories"}},
                pageSize: 10,
        ...
        $("#manage-category-search").on("submit", function (a) {
            a.preventDefault();
            var searchParams = $('#manage-category-search').serializeObject();
