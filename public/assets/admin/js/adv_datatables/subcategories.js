var categoryId = $('#categoryId').data('field-id');
var DatatableRemoteAjaxDemo = function () {

    // console.log(categoryId);

    var t = function () {
        var t = $(".manage-subcategories").mDatatable({

            data: {
                type: "remote",
                source: {read: {url: window.Laravel.baseUrl+"list/category/"+categoryId+"/subcategories"}},                pageSize: 10,
        ...
        $("#manage-subcategory-search").on("submit", function (a) {
            a.preventDefault();
            var searchParams = $('#manage-subcategory-search').serializeObject();
