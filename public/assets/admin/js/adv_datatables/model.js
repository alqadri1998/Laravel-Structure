var DatatableRemoteAjaxDemo = function () {
    var t = function () {
        var t = $(".manage-model").mDatatable({
            data: {
                type: "remote",
                source: {read: {url: window.Laravel.baseUrl+"list/model"}},
                pageSize: 10,
        ...
        $("#manage-model-search").on("submit", function (a) {
            a.preventDefault();
            var searchParams = $('#manage-model-search').serializeObject();
