var DatatableRemoteAjaxDemo = function () {
        var t = function () {
            var t = $(".manage-my-claims").mDatatable({
                data: {
                    type: "remote",
                    source: {read: {url: window.Laravel.baseUrl+"list/my-claims"}},
                    pageSize: 10,
                ...
                columns:
                    [
                        ...
                        {field: "package_list", title: "Package Id",  width: 150},
            ...
            $("#manage-my-claims-search").on("submit", function (a) {
                a.preventDefault();
                var searchParams = $('#manage-my-claims-search').serializeObject();
