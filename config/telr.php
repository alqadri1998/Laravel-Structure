...
return [
    ...
    'create' => [
        ...
        'return_auth' => 'http://127.0.0.1:8000/handle-payment/success',
        'return_can' => 'http://127.0.0.1:8000/handle-payment/cancel',
        'return_decl' => 'http://127.0.0.1:8000/handle-payment/declined',
        'ivp_framed' => 1,
    ]
];