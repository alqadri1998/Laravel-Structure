...
@include('emails.layouts.simple_header', ['mailTitle' => 'Password Reset Link'])
...
<table border='0' cellpadding='0' cellspacing='0' style="width: 100%;">
    <tr>
        <td style="width: 100%; padding:0 50px 28px;background: #ebebeb; box-sizing: border-box;">
            ...
            <a href="{!! route('admin.auth.forgot-password.show-reset-form', $token) !!}" style="width: 200px; height: 20px; background: #d60400; padding:10px 0; display: block; color: #fff; text-align: center; text-decoration:none; font-size: 14px; border-radius: 5px;">Set New Password</a>
