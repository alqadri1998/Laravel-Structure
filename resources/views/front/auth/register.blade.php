                    ...
                    <form id="register-form" action="{{route('front.auth.register')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group m-b-25 col-sm-6">
                                ...
                                <input type="text" class="form-control required" id="first_name" value="{{old('first_name')}}"
                            ...
                            <div class="form-group m-b-25 col-sm-6">
                                ...
                                <input type="text" class="form-control required" id="last_name" value="{{old('last_name')}}"
                        ...
                        <div class="form-group m-b-25">
                            ...
                            <input type="email" class="form-control required" id="email" placeholder="{!! __('e.g') !!} johndoe@example.com" value="{{old('email')}}"
                                   name="email" required>
                        ...
                        <div class="form-group form-check m-b-25">
                            <label class="checkbox-container forget-paswd">{!! __('By Signing up, I agree to') !!} <a
                                        href="{{ route('front.pages', ['slug' => config('settings.terms_and_conditions')]) }}" target="_blank" class="policy-link">{!! __('Terms & Conditions') !!}</a>
                                {!! __('and') !!}
                                <a href="{{ route('front.pages', ['slug' => config('settings.privacy_policy')]) }} " target="_blank" class="policy-link">{!! __('Privacy Policy') !!}</a>
