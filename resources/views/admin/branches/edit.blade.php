...
{{--    @include('admin.common.tinymce-script')--}}
    ...
    <script>
        ...
        function geocodePosition(pos) {
            ...
            var latitude = {!! ($branch->id > 0) ? ((empty($branch->latitude) ? 31.55460609999999 : $branch->latitude)) : 31.55460609999999 !!};
            var longitude = {!! ($branch->id > 0) ? ((empty($branch->longitude) ? 74.35715809999999 : $branch->longitude)) : 74.35715809999999 !!};
                ...
                <div class="tab-content">
                    @if($branch->id > 0)
                        <div class="tab-pane " id="tab_ar">
                            @include('admin.branches.form', ['languageId' => $locales['ar']])
                        </div>
                    @endif
                    <div class="tab-pane active" id="tab_en">
                        @include('admin.branches.form', ['languageId' => $locales['en']])
                    </div>
                </div>
            </div>
        </div>
