...
@push('script-page-level')
    ...
    <script src="{{asset('assets/admin/js/adv_datatables/subscriptions.js')}}" type="text/javascript"></script>
@endpush
...
@section('content')
        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-title">
                <h3 class="m-portlet__head-text">
                    Subscriptions
                    <small>
                        All emails that have subscription
                    </small>
                </h3>
            </div>
        </div>
                ...
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <div class="m-dropdown m-dropdown--inline m-dropdown--arrow m-dropdown--align-right m-dropdown--align-push" data-dropdown-toggle="hover" aria-expanded="true">
                            <a href="{!! route('admin.services.edit', 0) !!}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                <span>
    ...
    <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30 collapse" id="m_datatable_group_action_form_page">
        ...
        <div class="m-portlet__body">
            ...
            <!--end: Search Form -->
            <!--begin: Datatable -->
            <div class="manage-subscriptions" id="local_data"></div>
            <!--end: Datatable -->
        </div>
    <!--end: Datatable -->
    </div>
