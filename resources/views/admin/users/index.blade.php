...
@section('content')
    ...
    <div class="m-portlet m-portlet--mobile">
                ...
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <div class="m-dropdown m-dropdown--inline m-dropdown--arrow m-dropdown--align-right m-dropdown--align-push" data-dropdown-toggle="hover" aria-expanded="true">
                            <a href="{!! route('admin.users.edit', ['user' => 0]) !!}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                <span>
        ...
        <div class="m-portlet__body">
                        ...
                        <form class="form-group m-form__group row align-items-center" action="" id="manage-user-search">
                            ...
                            <div class="col-md-4 m--margin-bottom-10">
                                <div class="m-form__group m-form__group--inline">
                                    ...
                                    <div class="m-form__control">
                                        <input type="text" class="form-control m-bootstrap-select" name="first_name" placeholder="First Name">
                                    </div>
                                </div>
                            </div>
                            ...
                            {{--<div class="col-md-4 m--margin-bottom-10">--}}
                                {{--<div class="m-form__group m-form__group--inline">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<div class="m-form__control">--}}
                                        {{--<select  class="form-control" id="show-user-gender" name="userGender">--}}
                                ...
                                <div class="m-form__group m-form__group--inline">
                                    ...
                                    <div class="m-form__label">
                                        <label class="m-checkbox m-checkbox--bold m-checkbox--state-brand">
                                            <input type="checkbox" name="trashedItems"  id="show-trashed-users">
                                            Show Trashed Users
                                            <span></span>
                                        </label>
                                    </div>
            ...
            <!--begin: Datatable -->
            <div class="manage-users" id="local_data"></div>
            <!--end: Datatable -->
        </div>
    </div>
