...
{!! Form::open(['url' => $action, 'method' => 'post', 'role' => 'form', 'class' => 'm-form m-form--fit m-form--label-align-right', 'enctype' => 'multipart/form-data']) !!}
    ...
    <div class="m-form__actions">
        <div class="row">
            ...
            <div class="col-7">
                ...
                &nbsp;&nbsp;
                <a href="{!! route('admin.translations.index') !!}" class="btn btn-secondary m-btn m-btn--air m-btn--custom">Cancel</a>
